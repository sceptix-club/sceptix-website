...
const AboutUs = () => {
  return (
    ...
    <section className="py-12 sm:mt-48 mt-10">
      <div className="container mx-auto p-8">
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-8 text-white sm:mx-20">
          ...
          <div className="text-center">
            <GiFist className="mx-auto" style={{color: 'blueviolet', fontSize: '50px'}} />
    ...
    <section className="sm:mt-48 mt-10 ">
       <Footer />
    </section>
    </>
  );
